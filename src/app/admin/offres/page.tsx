...
// L'ingestion en lot fait un fetch + un appel Claude par URL, séquentiellement :
...
export default async function AdminOffresPage() {
  ...
  return (
    <div className="mx-auto max-w-xl">
      <h1 style={{ fontSize: 28, margin: 0 }}>Ingestion d&apos;offres (Claude)</h1>
      <p style={{ fontSize: 14, color: "color-mix(in srgb, var(--color-text) 70%, transparent)", margin: "6px 0 0" }}>
        Colle une URL d&apos;offre publique ou son contenu brut : Claude
