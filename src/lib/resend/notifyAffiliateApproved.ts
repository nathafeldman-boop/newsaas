...
<p>Ta candidature au programme d'affiliation Stageio est approuvée ! Tu touches désormais <strong>50% de commission</strong> sur chaque abonnement hebdomadaire (4,50€) ou mensuel (7,99€) que tu apportes, sur toute la durée de l'abonnement.</p>
<p>Ton lien d'affiliation unique : <a href="${SITE_URL}/inscription?aff=${code}">${SITE_URL}/inscription?aff=${code}</a></p>
