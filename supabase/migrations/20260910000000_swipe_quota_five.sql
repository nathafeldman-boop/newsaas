-- Quota gratuit relevé de 3 à 5/semaine. Miroir de FREE_WEEKLY_SWIPE_QUOTA
-- côté app (src/lib/subscription/quota.ts) -- les deux doivent toujours
-- matcher.
...
begin
  ...
  if v_recent_browse_count >= 5 then
    raise exception 'SWIPE_QUOTA_REACHED'
      using errcode = 'P0001',
            hint = 'Quota hebdomadaire de swipes gratuits atteint (5/semaine).';
  end if;
